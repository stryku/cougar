...
PI_ const s_productionInfo[] = 
{
     ...
     {275, 1}, // 1: module ->  module_decls
     {276, 1}, // 2: module_decls ->  module_decl
     {276, 1}, // 3: module_decls ->  module_decls
     {277, 1}, // 4: module_decl ->  module_name_defitnion
     {277, 1}, // 5: module_decl ->  external_function_declaration
     {278, 3}, // 6: module_name_defitnion (KwModule) ->  KwModule Identifier Semicolon
     {279, 8}, // 7: external_function_declaration (KwExternal) ->  KwExternal KwFunction Identifier Identifier ParentOpen param_declations ParentClose Semicolon
     {280, 1}, // 8: param_declations ->  param_declaration
     {280, 3}, // 9: param_declations (Comma) ->  param_declations Comma param_declaration
     {281, 1}, // 10: param_declaration (Identifier) ->  Identifier
     {281, 2}, // 11: param_declaration (Identifier) ->  Identifier Identifier
     {282, 1}, // 12: module_$ ->  module
};
...
SR_ s_0[] =
{
    ...
    { {       276}, { 2} }, // module_decls                 
    { {       277}, { 3} }, // module_decl                  
    { {       278}, { 4} }, // module_name_defitnion        
    { {       279}, { 5} }, // external_function_declaration
    { {       263}, { 6} }, // KwModule                     
    { {       260}, { 7} }, // KwExternal                   
    { {         0}, { 0} },                                 
};
...
{
    { { REQ_TOKEN}, {  4} },                     
    { {       280}, { 14} }, // param_declations 
    { {       281}, { 15} }, // param_declaration
    { {       273}, { 16} }, // Identifier       
    { {         0}, {  0} },                     
};
...
SMapVal s_symArr[] =
{
    ...
    SMapVal(257, "KwPrivate"),
    SMapVal(258, "KwPublic"),
    SMapVal(259, "KwExported"),
    SMapVal(260, "KwExternal"),
    SMapVal(261, "KwFunction"),
    SMapVal(262, "KwReturn"),
    SMapVal(263, "KwModule"),
    SMapVal(264, "LitNumber"),
    SMapVal(265, "LitString"),
    SMapVal(266, "BraceOpen"),
    SMapVal(267, "BraceClose"),
    SMapVal(268, "ParentOpen"),
    SMapVal(269, "ParentClose"),
    SMapVal(270, "Semicolon"),
    SMapVal(271, "Operator"),
    SMapVal(272, "Comma"),
    SMapVal(273, "Identifier"),
    SMapVal(274, "Eof"),
    SMapVal(275, "module"),
    SMapVal(276, "module_decls"),
    SMapVal(277, "module_decl"),
    SMapVal(278, "module_name_defitnion"),
    SMapVal(279, "external_function_declaration"),
    SMapVal(280, "param_declations"),
    SMapVal(281, "param_declaration"),
    SMapVal(282, "module_$"),
};
...
// base/base1
Parser_generatedBase::Parser_generatedBase()
:
...
// base/clearin
void Parser_generatedBase::clearin_()
{
    d_nErrors_ = 0;
    d_stackIdx = -1;
    d_stateStack.clear();
...
std::string Parser_generatedBase::symbol_(int value) const
{
    using namespace std;
    ostringstream ostr;
...
void Parser_generatedBase::setDebug(bool mode)
{
    d_actionCases_ = false;
    d_debug_ = mode;
}

void Parser_generatedBase::setDebug(DebugMode_ mode)
{
...
// base/lex
void Parser_generatedBase::lex_(int token)
{
    d_token = token;
...
// base/lookup
int Parser_generatedBase::lookup_() const
{
...
// base/pop
void Parser_generatedBase::pop_(size_t count)
{
...
// base/poptoken
void Parser_generatedBase::popToken_()
{
...
// base/push
void Parser_generatedBase::push_(size_t state)
{
...
// base/pushtoken
void Parser_generatedBase::pushToken_(int token)
{
...
// base/redotoken
void Parser_generatedBase::redoToken_()
{
...
// base/reduce
void Parser_generatedBase::reduce_(int rule)
{
...
// base/shift
void Parser_generatedBase::shift_(int action)
{
    push_(action);
...
// base/startrecovery
void Parser_generatedBase::startRecovery_()
{
...
// base/top
inline size_t Parser_generatedBase::top_() const
{
    return d_stateStack[d_stackIdx].first;
}

// derived/errorrecovery
void Parser_generated::errorRecovery_()
{
...
void Parser_generated::executeAction_(int production)
try
{
...
// derived/nextcycle
void Parser_generated::nextCycle_()
try
{
...
// derived/nexttoken
void Parser_generated::nextToken_()
{ 
...
// $insert print
    ...
    if (token_() == Reserved_::UNDETERMINED_)
        ...
        std::cout << Cougar::Parser::LexerAdaptor::currentText() << "'\n";
}

// derived/parse
int Parser_generated::parse()
try 
{
